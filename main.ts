namespace SpriteKind {
    ...
    export const boss_2 = SpriteKind.create()
}
namespace myTiles {
...
. . . 7 . . f d 1 5 1 5 1 5 1 5 d f . . . . . . 
. . . 7 . . f d 5 5 5 5 5 5 5 5 d f . . . . . . 
. . . 7 . . f d d d 5 5 5 5 d d d f f . . . . . 
...
tiles.setTilemap(tiles.createTilemap(
            hex``,
            img`
. . . . . . . . . . . . . . . . . . . . 
. . . . . . . . . . . . . . . . . . . . 
. . . . . . . . . . . . . . . . . . . . 
...
. . . . . . . . . . . . . . . . . . . . 
`,
            [myTiles.tile0,sprites.castle.tilePath6,sprites.castle.tilePath3,sprites.castle.tilePath9],
            TileScale.Sixteen
        ))
bossLife = 100
info.setLife(50)
...
lifeBarPic = image.create(111, 5)
lifeBar = sprites.create(lifeBarPic, SpriteKind.LifeBar)
lifeBar.setPosition(80, 5)
offset = 0
MAX = 10
bossCanMove = true
preSetBossPosition(80, -80)
game.onUpdateInterval(100, function () {
    if (ready && !(started)) {
        let mySprite2 = 0
        for (let index3 = 0; index3 <= MAX - 1; index3++) {
            for (let index = 0; index < 3; index++) {
                shootBulletFromSprite(boss, 60, Math.randomRange(360, mySprite2) / MAX * index3 + offset)
                shootBulletFromSprite(boss, 100, 360 / MAX * (index3 * 0.5) + offset)
            }
        }
        if (lifeBarProgress < 4) {
            lifeBarPic.fillRect(40 * lifeBarProgress, 0, 40, 5, 14 * (lifeBarProgress % 2 * 6))
            lifeBarPic.fillRect(40 * lifeBarProgress, 1, 40, 3, lifeBarProgress % 2 * 5 * 4)
            lifeBar.setImage(lifeBarPic)
            lifeBarProgress += 2
        } else {
            started = false
...
game.onUpdateInterval(500, function () {
    if (ready && !(started)) {
        if (lifeBarProgress < 5) {
            lifeBarPic.fillRect(30 * lifeBarProgress, 0, 20, 5, 14 - lifeBarProgress % 20 * 20)
            lifeBarPic.fillRect(24 * lifeBarProgress, 1, 24, 3, lifeBarProgress % 2 * 20 * 20)
            for (let index2 = 0; index2 <= MAX - 1; index2++) {
                shootBulletFromSprite(boss, 100, 400 / MAX * index2 + offset)
            }
            offset += 20
            lifeBar.setImage(lifeBarPic)
            lifeBarProgress += 2
